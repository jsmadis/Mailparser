...
public class AttachmentOdtParseTest extends AbstractParserTest {
    @Override
    ...
    public List<EmailToParse> createEmails() {
        ...
        emailToParse.addFile(new File(getClass().getClassLoader().getResource("testing_attachment.odt").getFile()))
                .messageId("123456")
