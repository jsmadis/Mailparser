...
public class SubjectParseTest extends AbstractParserTest {
    @Override
    public Mailbox setupMailbox() {
        Mailbox mailbox = new Mailbox();
        ParsingRule parsingRule = new ParsingRule();
        parsingRule.setMailbox(mailbox);
        parsingRule.setComponent(EmailComponent.SUBJECT);
    ...
    @Test
    public void testPlainTextParseSubject() {
        assertThat(parsedDataList).hasSize(1);
        assertThat(parsedDataList.get(0).getValues()).hasSize(1);
        assertThat(parsedDataList.get(0).getValues().get(0)).isEqualTo("Testing subject");
    ...
    public List<EmailToParse> createEmails() {
        ...
        emailToParse.subject("Testing subject")
                .messageId("123456")
